            ...
            <Drawer isOpen={isOpen} size="md" anchor="bottom" onClose={closeDrawer}>
                ...
                <DrawerContent>
                    ...
                    <DrawerBody>
                        ...
                        {!isLoading && data && data.items.length === 0 && <Text className="text-center">Ingen måltider fundet</Text>}
                                    ...
                                    <HStack className={"justify-between flex-1 p-4"}>
                                        <VStack>
                                            ...
                                            <Text className="text-sm text-gray-500 mt-2">
                                                Afhent idag {moment(meal.firstAvailablePickup).format("HH:mm")} - {moment(meal.lastAvailablePickup).format("HH:mm")}
                                            </Text>
                                        </VStack>
